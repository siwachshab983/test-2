    ...
    return (
        <>
            <div className="px-5 bg-[url(./assets/images/png/best-seller-bg-img.png)] bg-no-repeat bg-cover bg-center py-[50px] md:pt-25 md:pb-[49px] relative">
                <img className='absolute pointer-events-none md:flex hidden left-0 bottom-0 max-xl:w-full max-xl:max-w-[100px]' src={pizzaSlice} alt="pizza-slice" />
                        ...
                        <div className="lg:max-w-[558px]">
                            ...
                            <div className="flex flex-wrap mt-6 gap-4 sm:gap-6 lg:max-h-[135px] max-lg:justify-center">
                                {ABOUT_US_CARDS_DATA.map((item, index) => (
                                    <div data-aos="fade-up" className={`${index === 1 ? "sm:mt-3" : ""}`}>
                                        <div key={index} className="bg-off-white w-full min-w-[160px] sm:max-w-[170px] sm:min-w-[170px] p-3 sm:p-4.5 shadow-[0px_1px_7px_0px_#F67A211F] relative rounded-xl">
