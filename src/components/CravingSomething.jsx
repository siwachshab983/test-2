      ...
      <div className="bg-[url(./assets/images/png/CravingSomething-bg-img.png)] bg-cover bg-center bg-no-repeat px-5 relative">
        <div className="py-10 md:py-20 relative z-1">
          ...
          <div className="flex gap-4 sm:gap-6 mt-5.5 sm:mt-8 sm:flex-row flex-col  justify-center sm:items-start items-center">
            <Button className="px-[29px] sm:px-[33px] py-3.5 sm:max-w-none max-w-[400px] max-sm:w-full">Order Now</Button>
            <Button className={'!bg-none btn-blur-opacity-1 !py-[15px] border border-white sm:max-w-none max-w-[400px] max-sm:w-full'}>View Full Menu</Button>
          </div>
        </div>
      </div>
    </>
